...
import br.com.supera.smartiot.service.ConsumerService;
...
/**
 * REST controller for managing {@link br.com.supera.smartiot.domain.Consumer}.
 */
@RestController
...
public class ConsumerResource {
    ...
    public ResponseEntity<ConsumerDTO> createConsumer(@Valid @RequestBody ConsumerDTO consumerDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/consumers/" + consumerDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, consumerDTO.getId().toString()))
            .body(consumerDTO);
    }
