...
/**
 * REST controller for managing {@link br.com.supera.smartiot.domain.ApplicationUser}.
 */
@RestController
...
public class ApplicationUserResource {
    ...
    public ResponseEntity<List<ApplicationUserDTO>> getAllApplicationUsers(
        ...
        if ("useraccount-is-null".equals(filter)) {
            log.debug("REST request to get all ApplicationUsers where userAccount is null");
            return new ResponseEntity<>(applicationUserService.findAllWhereUserAccountIsNull(), HttpStatus.OK);
        }
