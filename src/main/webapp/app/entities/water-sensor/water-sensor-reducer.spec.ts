...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WATERSENSOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WATERSENSOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WATERSENSOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WATERSENSOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WATERSENSOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WATERSENSOR actions', async () => {
      const arg = 42666;
