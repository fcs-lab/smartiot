  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="smartiotApp.cliente.home.createOrEditLabel" data-cy="ClienteCreateUpdateHeading">
            <Translate contentKey="smartiotApp.cliente.home.createOrEditLabel">Create or edit a Cliente</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('smartiotApp.cliente.nome')}
                id="cliente-nome"
                name="nome"
                data-cy="nome"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('smartiotApp.cliente.email')}
                id="cliente-email"
                name="email"
                data-cy="email"
                type="text"
