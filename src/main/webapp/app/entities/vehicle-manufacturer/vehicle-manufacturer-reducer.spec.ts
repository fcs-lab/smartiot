...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VEHICLEMANUFACTURER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VEHICLEMANUFACTURER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VEHICLEMANUFACTURER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VEHICLEMANUFACTURER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VEHICLEMANUFACTURER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VEHICLEMANUFACTURER actions', async () => {
      const arg = 42666;
