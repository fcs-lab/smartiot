...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESOURCEGROUP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RESOURCEGROUP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RESOURCEGROUP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RESOURCEGROUP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RESOURCEGROUP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RESOURCEGROUP actions', async () => {
      const arg = 42666;
