  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="smartiotApp.vehicleModel.home.createOrEditLabel" data-cy="VehicleModelCreateUpdateHeading">
            <Translate contentKey="smartiotApp.vehicleModel.home.createOrEditLabel">Create or edit a VehicleModel</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('smartiotApp.vehicleModel.modelName')}
                id="vehicle-model-modelName"
                name="modelName"
                data-cy="modelName"
                type="text"
                validate={{
