  ...
  return (
    <div>
      <h2 id="vehicle-model-heading" data-cy="VehicleModelHeading">
        <Translate contentKey="smartiotApp.vehicleModel.home.title">Vehicle Models</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="smartiotApp.vehicleModel.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/vehicle-model/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="smartiotApp.vehicleModel.home.createLabel">Create new Vehicle Model</Translate>
          </Link>
        </div>
      </h2>
        ...
        {vehicleModelList && vehicleModelList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="smartiotApp.vehicleModel.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="smartiotApp.vehicleModel.home.notFound">No Vehicle Models found</Translate>
            </div>
          )
        )}
      </div>
