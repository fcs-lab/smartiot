...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './storage-attachment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STORAGEATTACHMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STORAGEATTACHMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STORAGEATTACHMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STORAGEATTACHMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STORAGEATTACHMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STORAGEATTACHMENT actions', async () => {
      const arg = 42666;
