...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEVICECOMMAND_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DEVICECOMMAND actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DEVICECOMMAND actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DEVICECOMMAND actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DEVICECOMMAND actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DEVICECOMMAND actions', async () => {
      const arg = 42666;
