...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VEHICLEDAMAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VEHICLEDAMAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VEHICLEDAMAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VEHICLEDAMAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VEHICLEDAMAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VEHICLEDAMAGE actions', async () => {
      const arg = 42666;
