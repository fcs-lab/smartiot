...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WATERUSAGELOG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WATERUSAGELOG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WATERUSAGELOG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WATERUSAGELOG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WATERUSAGELOG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WATERUSAGELOG actions', async () => {
      const arg = 42666;
