...
export const UserRoleUpdate = () => {
  ...
  const handleClose = () => {
    navigate('/user-role' + location.search);
  };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="smartiotApp.userRole.home.createOrEditLabel" data-cy="UserRoleCreateUpdateHeading">
            <Translate contentKey="smartiotApp.userRole.home.createOrEditLabel">Create or edit a UserRole</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('smartiotApp.userRole.roleName')}
