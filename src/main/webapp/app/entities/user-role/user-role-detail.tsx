    ...
    <Row>
      <Col md="8">
        <h2 data-cy="userRoleDetailsHeading">
          <Translate contentKey="smartiotApp.userRole.detail.title">UserRole</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="roleName">
              <Translate contentKey="smartiotApp.userRole.roleName">Role Name</Translate>
            </span>
          </dt>
          <dd>{userRoleEntity.roleName}</dd>
        </dl>
