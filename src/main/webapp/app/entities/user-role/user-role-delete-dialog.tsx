...
export const UserRoleDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/user-role' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="smartiotApp.userRole.delete.question">
        <Translate contentKey="smartiotApp.userRole.delete.question" interpolate={{ id: userRoleEntity.id }}>
