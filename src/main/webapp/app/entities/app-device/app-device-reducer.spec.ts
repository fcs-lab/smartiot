...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPDEVICE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_APPDEVICE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_APPDEVICE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_APPDEVICE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_APPDEVICE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_APPDEVICE actions', async () => {
      const arg = 42666;
