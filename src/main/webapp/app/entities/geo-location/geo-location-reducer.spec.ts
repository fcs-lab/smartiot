...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GEOLOCATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GEOLOCATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GEOLOCATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GEOLOCATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GEOLOCATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GEOLOCATION actions', async () => {
      const arg = 42666;
