...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './chat-user.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHATUSER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHATUSER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHATUSER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CHATUSER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CHATUSER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHATUSER actions', async () => {
      const arg = 42666;
