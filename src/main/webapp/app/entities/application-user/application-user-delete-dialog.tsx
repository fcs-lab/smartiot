...
export const ApplicationUserDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="smartiotApp.applicationUser.delete.question">
        <Translate contentKey="smartiotApp.applicationUser.delete.question" interpolate={{ id: applicationUserEntity.id }}>
