  ...
  return (
    <div>
      <h2 id="enrollment-heading" data-cy="EnrollmentHeading">
        <Translate contentKey="smartiotApp.enrollment.home.title">Enrollments</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="smartiotApp.enrollment.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/enrollment/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="smartiotApp.enrollment.home.createLabel">Create new Enrollment</Translate>
          </Link>
        </div>
      </h2>
        ...
        {enrollmentList && enrollmentList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="smartiotApp.enrollment.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('enrollmentType')}>
                  <Translate contentKey="smartiotApp.enrollment.enrollmentType">Enrollment Type</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('enrollmentType')} />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="smartiotApp.enrollment.home.notFound">No Enrollments found</Translate>
            </div>
          )
        )}
      </div>
