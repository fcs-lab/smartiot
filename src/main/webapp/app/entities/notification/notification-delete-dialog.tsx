...
export const NotificationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="smartiotApp.notification.delete.question">
        <Translate contentKey="smartiotApp.notification.delete.question" interpolate={{ id: notificationEntity.id }}>
