...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './consumer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONSUMER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CONSUMER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CONSUMER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CONSUMER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CONSUMER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CONSUMER actions', async () => {
      const arg = 42666;
