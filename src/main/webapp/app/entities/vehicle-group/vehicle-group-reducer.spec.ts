...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VEHICLEGROUP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VEHICLEGROUP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VEHICLEGROUP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VEHICLEGROUP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VEHICLEGROUP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VEHICLEGROUP actions', async () => {
      const arg = 42666;
