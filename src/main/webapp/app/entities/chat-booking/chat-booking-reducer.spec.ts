...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHATBOOKING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHATBOOKING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHATBOOKING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CHATBOOKING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CHATBOOKING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHATBOOKING actions', async () => {
      const arg = 42666;
