...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SYSTEMALERT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SYSTEMALERT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SYSTEMALERT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SYSTEMALERT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SYSTEMALERT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SYSTEMALERT actions', async () => {
      const arg = 42666;
