...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VEHICLEINFO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VEHICLEINFO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VEHICLEINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VEHICLEINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VEHICLEINFO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VEHICLEINFO actions', async () => {
      const arg = 42666;
