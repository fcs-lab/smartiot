...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './vehicle-status-log.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VEHICLESTATUSLOG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VEHICLESTATUSLOG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VEHICLESTATUSLOG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VEHICLESTATUSLOG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VEHICLESTATUSLOG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VEHICLESTATUSLOG actions', async () => {
      const arg = 42666;
