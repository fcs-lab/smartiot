...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VEHICLESERVICE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VEHICLESERVICE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VEHICLESERVICE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VEHICLESERVICE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VEHICLESERVICE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VEHICLESERVICE actions', async () => {
      const arg = 42666;
