...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEASUREMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MEASUREMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MEASUREMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MEASUREMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MEASUREMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MEASUREMENT actions', async () => {
      const arg = 42666;
