...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERDASHBOARD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERDASHBOARD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERDASHBOARD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_USERDASHBOARD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_USERDASHBOARD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERDASHBOARD actions', async () => {
      const arg = 42666;
