...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MANUALENTRY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MANUALENTRY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MANUALENTRY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MANUALENTRY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MANUALENTRY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MANUALENTRY actions', async () => {
      const arg = 42666;
