...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './water-measurement.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WATERMEASUREMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WATERMEASUREMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WATERMEASUREMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WATERMEASUREMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WATERMEASUREMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WATERMEASUREMENT actions', async () => {
      const arg = 42666;
