...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DADOSENSOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DADOSENSOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DADOSENSOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DADOSENSOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DADOSENSOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DADOSENSOR actions', async () => {
      const arg = 42666;
