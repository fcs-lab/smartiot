  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="smartiotApp.pricing.home.createOrEditLabel" data-cy="PricingCreateUpdateHeading">
            <Translate contentKey="smartiotApp.pricing.home.createOrEditLabel">Create or edit a Pricing</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('smartiotApp.pricing.serviceType')}
              ...
              />
              <ValidatedField
                label={translate('smartiotApp.pricing.price')}
                id="pricing-price"
                name="price"
                data-cy="price"
                type="text"
