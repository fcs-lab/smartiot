...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './car-ride.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARRIDE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CARRIDE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CARRIDE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CARRIDE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CARRIDE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CARRIDE actions', async () => {
      const arg = 42666;
