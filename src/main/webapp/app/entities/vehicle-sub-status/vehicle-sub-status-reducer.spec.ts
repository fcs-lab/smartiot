...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './vehicle-sub-status.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VEHICLESUBSTATUS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VEHICLESUBSTATUS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VEHICLESUBSTATUS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VEHICLESUBSTATUS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VEHICLESUBSTATUS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VEHICLESUBSTATUS actions', async () => {
      const arg = 42666;
