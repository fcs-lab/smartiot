...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEVICETELEMETRY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DEVICETELEMETRY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DEVICETELEMETRY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DEVICETELEMETRY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DEVICETELEMETRY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DEVICETELEMETRY actions', async () => {
      const arg = 42666;
