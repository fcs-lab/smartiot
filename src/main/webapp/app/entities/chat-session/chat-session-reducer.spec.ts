...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHATSESSION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHATSESSION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHATSESSION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CHATSESSION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CHATSESSION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHATSESSION actions', async () => {
      const arg = 42666;
