...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WATERALERT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WATERALERT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WATERALERT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WATERALERT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WATERALERT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WATERALERT actions', async () => {
      const arg = 42666;
