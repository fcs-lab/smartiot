  ...
  return (
    <div>
      <h2 id="report-heading" data-cy="ReportHeading">
        <Translate contentKey="smartiotApp.report.home.title">Reports</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="smartiotApp.report.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/report/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="smartiotApp.report.home.createLabel">Create new Report</Translate>
          </Link>
        </div>
      </h2>
        ...
        {reportList && reportList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="smartiotApp.report.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('reportName')}>
                  <Translate contentKey="smartiotApp.report.reportName">Report Name</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('reportName')} />
                </th>
                <th className="hand" onClick={sort('reportData')}>
                  <Translate contentKey="smartiotApp.report.reportData">Report Data</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('reportData')} />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="smartiotApp.report.home.notFound">No Reports found</Translate>
            </div>
          )
        )}
      </div>
