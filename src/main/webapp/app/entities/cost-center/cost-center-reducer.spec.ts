...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COSTCENTER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COSTCENTER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COSTCENTER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_COSTCENTER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_COSTCENTER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COSTCENTER actions', async () => {
      const arg = 42666;
