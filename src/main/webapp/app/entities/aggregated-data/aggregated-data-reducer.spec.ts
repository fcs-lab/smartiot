...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AGGREGATEDDATA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AGGREGATEDDATA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AGGREGATEDDATA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AGGREGATEDDATA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AGGREGATEDDATA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AGGREGATEDDATA actions', async () => {
      const arg = 42666;
