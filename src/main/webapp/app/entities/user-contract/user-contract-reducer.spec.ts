...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERCONTRACT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERCONTRACT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERCONTRACT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_USERCONTRACT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_USERCONTRACT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERCONTRACT actions', async () => {
      const arg = 42666;
