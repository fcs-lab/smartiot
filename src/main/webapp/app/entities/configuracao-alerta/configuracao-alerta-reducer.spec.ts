...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './configuracao-alerta.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONFIGURACAOALERTA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CONFIGURACAOALERTA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CONFIGURACAOALERTA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CONFIGURACAOALERTA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CONFIGURACAOALERTA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CONFIGURACAOALERTA actions', async () => {
      const arg = 42666;
