...
describe('UserRole e2e test', () => {
  ...
  const userRoleSample = { roleName: 'obsession enthusiastically female' };
  ...
  describe('new UserRole page', () => {
    ...
    it('should create an instance of UserRole', () => {
      cy.get(`[data-cy="roleName"]`).type('photo why');
      cy.get(`[data-cy="roleName"]`).should('have.value', 'photo why');
