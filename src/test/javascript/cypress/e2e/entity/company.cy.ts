...
describe('Company e2e test', () => {
  ...
  const companySample = { name: 'um inasmuch', address: 'concerning plus' };
  ...
  describe('new Company page', () => {
    ...
    it('should create an instance of Company', () => {
      cy.get(`[data-cy="name"]`).type('instantly');
      cy.get(`[data-cy="name"]`).should('have.value', 'instantly');

      cy.get(`[data-cy="address"]`).type('gee minus meh');
      cy.get(`[data-cy="address"]`).should('have.value', 'gee minus meh');
