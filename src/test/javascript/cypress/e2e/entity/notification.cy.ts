...
describe('Notification e2e test', () => {
  ...
  const notificationSample = { notificationType: 'aw', message: 'vacantly', sentDate: '2024-06-03T11:42:46.742Z' };
  ...
  describe('new Notification page', () => {
    ...
    it('should create an instance of Notification', () => {
      cy.get(`[data-cy="notificationType"]`).type('stockings than cord');
      cy.get(`[data-cy="notificationType"]`).should('have.value', 'stockings than cord');

      cy.get(`[data-cy="message"]`).type('needle');
      cy.get(`[data-cy="message"]`).should('have.value', 'needle');

      cy.get(`[data-cy="sentDate"]`).type('2024-06-03T07:51');
      cy.get(`[data-cy="sentDate"]`).blur();
      cy.get(`[data-cy="sentDate"]`).should('have.value', '2024-06-03T07:51');
