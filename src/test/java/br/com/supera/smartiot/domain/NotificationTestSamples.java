...
public class NotificationTestSamples {
    ...
    public static Notification getNotificationSample1() {
        return new Notification().id(1L).notificationType("notificationType1").message("message1");
    }

    public static Notification getNotificationSample2() {
        return new Notification().id(2L).notificationType("notificationType2").message("message2");
    }
