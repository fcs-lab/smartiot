...
import br.com.supera.smartiot.repository.PaymentRepository;
import br.com.supera.smartiot.service.dto.PaymentDTO;
import br.com.supera.smartiot.service.mapper.PaymentMapper;
...
class PaymentResourceIT {
    ...
    public static Payment createEntity(EntityManager em) {
        Payment payment = new Payment().amount(DEFAULT_AMOUNT).paymentDate(DEFAULT_PAYMENT_DATE);
        return payment;
    }
    ...
    public static Payment createUpdatedEntity(EntityManager em) {
        Payment payment = new Payment().amount(UPDATED_AMOUNT).paymentDate(UPDATED_PAYMENT_DATE);
        return payment;
    }
    ...
    void putExistingPayment() throws Exception {
        ...
        updatedPayment.amount(UPDATED_AMOUNT).paymentDate(UPDATED_PAYMENT_DATE);
    ...
    void fullUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.amount(UPDATED_AMOUNT).paymentDate(UPDATED_PAYMENT_DATE);
